...
const CelebrationAnimation = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none overflow-hidden">
      ...
      {[...Array(5)].map((_, i) => (
        <div
          ...
          style={{
            ...
            borderColor: i % 2 === 0 ? spiritualColors.gold : spiritualColors.purple,
            opacity: phase >= 1 ? Math.max(0, 0.6 - i * 0.15) : 0,
            transform: 'translate(-50%, -50%)',
            transition: `all ${2 + i * 0.3}s ease-out`,
            transitionDelay: `${i * 0.2}s`,
            boxShadow: `0 0 ${20 + i * 10}px ${i % 2 === 0 ? spiritualColors.gold : spiritualColors.purple}`,
          }}
        />
      ))}
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative" style={{ width: '400px', height: '400px' }}>
          ...
          {[...Array(32)].map((_, i) => {
            ...
            const colors = [spiritualColors.gold, spiritualColors.purple, spiritualColors.softBlue, spiritualColors.lightPurple];
            ...
            return (
              <div
                ...
                style={{
                  ...
                  left: '50%',
                  top: '50%',
                  transform: `translate(-50%, -50%) translate(${x * 0.3}px, ${y * 0.3}px) scale(0)`,
                  animation: `celebration-burst-enhanced 2s ease-out ${i * 0.02}s forwards`,
            ...
            return (
              <div
                ...
                style={{
                  ...
                  left: '50%',
                  top: '50%',
                  transform: `translate(-50%, -50%) translate(${x * 0.2}px, ${y * 0.2}px) scale(0)`,
                  animation: `celebration-burst-enhanced 1.5s ease-out ${0.3 + i * 0.015}s forwards`,
                  animationFillMode: 'forwards',
                  opacity: 0,
      ...
      {/* Floating light orbs */}
      {phase >= 1 && [...Array(30)].map((_, i) => {
        const size = Math.random() * 20 + 15;
        const left = Math.random() * 100;
        const top = Math.random() * 100;
        const delay = Math.random() * 2;
        const duration = 3 + Math.random() * 2;
        const colors = [spiritualColors.gold, spiritualColors.purple, spiritualColors.softBlue];
        const color = colors[Math.floor(Math.random() * colors.length)];
          ...
          >
            <div 
              ...
              style={{
                ...
                boxShadow: `0 0 ${size * 3}px ${spiritualColors.white}, 0 0 ${size * 5}px ${spiritualColors.gold}`,
              }}
            />
          </div>
        );
